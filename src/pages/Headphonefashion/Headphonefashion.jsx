...
const Headphonefashion = ({ setFavouriteId, setCartProductId, isSignedIn, headphonefashion }) => {
    ...
    return (
        <div>
            ...
            <div className='px-5 md:px-20 mt-5'>
                <div className='text-gray-700'><NavLink to="/">Home</NavLink> ❯ <NavLink to="/headphonefashion">HeadPhone's collection</NavLink></div>

                <label className='text-2xl flex flex-col justify-center md:justify-start w-[100%] mt-5'>
                ...
                <div className='flex flex-wrap gap-4 mt-5 justify-center md:justify-start'>
                    {
                        headphonefashion.map((items) => {
                            return (
                                <div key={items.id}>
                                    <div className='w-35 md:w-50 lg:w-60 '>
                                        <figure className='bg-gray-100 h-35 md:h-60 rounded flex'>
...
export default Headphonefashion