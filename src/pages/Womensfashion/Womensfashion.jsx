...
const Womensfashion = ({setFavouriteId , setCartProductId , isSignedIn , womensfashion}) => {
    ...
    return (
        <div>
            ...
            <div className='px-5 md:px-20 mt-5'>
                <div className='text-gray-700'><NavLink to="/">Home</NavLink> ❯ <NavLink to="/womensfashion">Women's fashion</NavLink></div>
