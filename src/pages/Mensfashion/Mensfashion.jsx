...
const Mensfashion = ({ setFavouriteId, setCartProductId, isSignedIn, mensfashion }) => {
    ...
    return (
        <div>
            ...
            <div className='px-5 md:px-20 mt-5'>
                <div className='text-gray-700'><NavLink to="/">Home</NavLink> ❯ <NavLink to="/mensfashion">Men's fashion</NavLink></div>
